              ...
              <div class="full">
                <div class="title-holder">
                  <div class="title-holder-cell text-left">
                    ...
                    <ol class="breadcrumb">
                      <li><a href="/">Home</a></li>
                      <li><a href="{{ env('APP_URL') }}admin-panel/service">Manage Service</a></li>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="checkout-form">
                <form
                  action="{{ env('APP_URL') }}admin-panel/store_service"       
                 method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    ...
                    <div class="center">
                    <button class="btn main_bt" type="submit">Create Service</button>
