    ...
    <div class="row">
      <div id="rev_slider_4_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="classicslider1" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
        ...
        <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
          <ul>
            <li data-index="rs-1812" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="{{ env('APP_URL') }}public/images/it_service/slide1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Gaming Equipment" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ env('APP_URL') }}public/images/it_service/slide1.jpg"  alt="#"  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
              <!-- LAYERS -->
              <!-- LAYER NR. BG -->
              ...
              <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              style="z-index: 6; white-space: nowrap;">Gaming Equipment </div>
              <!-- LAYER NR. 3 -->
            ...
            <li data-index="rs-181" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="{{ env('APP_URL') }}public/images/it_service/slide2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Best PC/PS Games" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ env('APP_URL') }}public/images/it_service/slide2.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
              <!-- LAYERS -->
              <!-- LAYER NR. BG -->
              <div class="tp-caption tp-shape tp-shapewrapper   rs-parallaxlevel-0" 
              ...
              <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              data-responsive_offset="on" 
                              data-elementdelay="0.05" 
                              style="z-index: 6; white-space: nowrap;">Best PC/PS Games </div>
              <!-- LAYER NR. 3 -->
              <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
            ...
            <li data-index="rs-18" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="{{ env('APP_URL') }}public/images/it_service/slide3.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Computer Repairs" data-description="">
              <!-- MAIN IMAGE -->
              <img src="{{ env('APP_URL') }}public/images/it_service/slide3.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
              <!-- LAYERS -->
              <!-- LAYER NR. BG -->
              <div class="tp-caption tp-shape tp-shapewrapper   rs-parallaxlevel-0" 
              ...
              <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              data-responsive_offset="on" 
                              data-elementdelay="0.05" 
                              style="z-index: 6; white-space: nowrap;">Computer Repairs </div>
              <!-- LAYER NR. 3 -->
              <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
                              id="slide-18-layer-4" 
                              data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 
    ...
    <div class="row">
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          <div class="center">
            <div class="icon"> <img src="{{ env('APP_URL') }}public/images/it_service/pcrepair.png" alt="#" /> </div>
          </div>
          <h4 class="theme_color">Console repairs</h4>
          <p>Quick and safe repairs of your consoles.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          <div class="center">
            <div class="icon"> <img src="{{ env('APP_URL') }}public/images/it_service/games.png" alt="#" /> </div>
          </div>
          <h4 class="theme_color">PC and PS Games</h4>
          <p>The widest selection of PC and PS games.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30">
          <div class="center">
            <div class="icon"> <img src="{{ env('APP_URL') }}public/images/it_service/equipment.png" alt="#" /> </div>
          </div>
          <h4 class="theme_color">Gaming equipment</h4>
          <p>Highest quality gaming equipment.</p>
        </div>
      </div>
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
        <div class="full text_align_center margin_bottom_30 margin_0">
          <div class="center">
            <div class="icon"> <img src="{{ env('APP_URL') }}public/images/it_service/delivery.png" alt="#" /> </div>
          </div>
          <h4 class="theme_color">Delivery</h4>
      ...
      <div class="col-md-12">
        <div class="full">
          <div class="main_heading text_align_left">
            ...
            <p class="large">Easy, efficient and fast way to repair your device.</p>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{ env('APP_URL') }}public/images/it_service/clock.png" alt="#" /></div>
                <h4 class="service-heading">Fast service</h4>
                <p>Fast execution of your services.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{ env('APP_URL') }}public/images/it_service/payment.png" alt="#" /></div>
                <h4 class="service-heading">Secure payments</h4>
                <p>All payment methods are provided for you in every way.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{ env('APP_URL') }}public/images/it_service/teamwork.png" alt="#" /></div>
                <h4 class="service-heading">Expert team</h4>
                <p>All our employees are experts in this category of work. </p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{ env('APP_URL') }}public/images/it_service/wallet.png" alt="#" /></div>
                <h4 class="service-heading">Affordable services</h4>
                <p>To date, we have not had a complaint about the expensive price of our services</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{ env('APP_URL') }}public/images/it_service/warranty.png" alt="#" /></div>
                <h4 class="service-heading">1 Year warranty</h4>
                <p>You have a minimum one-year warranty on all our services.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="full">
              <div class="service_blog_inner">
                <div class="icon text_align_left"><img src="{{ env('APP_URL') }}public/images/it_service/award.png" alt="#" /></div>
                <h4 class="service-heading">Award winning</h4>
                <p>We have won several awards in national computer science competitions.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 margin_bottom_30_all">
        <div class="product_list">
            ...
            <div class="product_detail_btm">
              <div class="center">
                <h4><a href="it_shop_detail.html">{{ $eq->title }}</a></h4>
              </div>
              <div class="starratin">
