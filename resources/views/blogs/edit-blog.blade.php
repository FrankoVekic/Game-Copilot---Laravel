          ...
          <div class="row">
            <div class="col-md-12">
              <div class="checkout-form">
                <form action="{{ env('APP_URL') }}blogs/{{ $blog->id }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                  <fieldset>
                  <div class="row">
                  <div class="col-md-12">
                      <div class="form-field">
                        <label> Upload a image (not necessary) <span class="red"></span></label>
                        <input class="inputcheckout" value="" name="image" type="file">
                      </div>
                    </div>
                    <div class="col-md-12">
                      <div class="form-field">
                        <label>Title <span class="red">*</span></label>
                        <input class="inputcheckout" name="title" value="{{ $blog->title }}" type="text">
                        @error('title')
                    ...
                    <div class="center">
                    <button class="btn main_bt" type="submit">Save</button>
